...
export default function ImmvelaPrivacyPage() {
  return (
    <div className="immvela-theme relative min-h-dvh bg-[#f2f1e8]">
      ...
      <main className="mx-auto w-full max-w-3xl px-5 pb-24 pt-12 md:pt-16">
        ...
        <div lang="de">
          ...
          <Section lang="de" title="Verbundene Social-Media-Konten und Veröffentlichung">
            <p>
              Wenn Sie ein Konto bei Instagram, Facebook, LinkedIn, TikTok oder YouTube mit Immvela
              verbinden, speichern wir den von der Plattform ausgestellten Zugriffs-Token,
            ...
            <p>
              ...
              <strong>zusammengefasste Reichweitenzahlen</strong> zu den von Ihnen veröffentlichten
              Beiträgen abzurufen.
            </p>
            <p>
              Diese Reichweitenzahlen sind <strong>Summenwerte je Plattform und je Beitrag</strong>{' '}
              — etwa Aufrufe, Reaktionen, Kommentaranzahl oder Weiterleitungen. Wir rufen{' '}
              <strong>keine personenbezogenen Daten zu einzelnen Nutzerinnen und Nutzern</strong>{' '}
              ab: keine Namen von Kommentierenden, keine Kommentartexte und keine Auswertungen nach
              Zielgruppenmerkmalen. Wir lesen keine privaten Nachrichten und keine Kontaktlisten.
            </p>
          </Section>

          <Section lang="de" title="Inhalte, die Sie anlegen">
            <p>
              Objektdaten, Adressen, hochgeladene Fotos und Videos, Bildtexte und geplante Beiträge.
              Mediendateien liegen in einem nicht öffentlichen Speicher; der Zugriff erfolgt über
              kurzlebige signierte Links.
            </p>
          </Section>
          ...
          <Section lang="de" title="Aufzeichnungen">
            <p>
              ...
              Kanal, sowie die abgerufenen zusammengefassten Reichweitenzahlen. Diese Aufzeichnungen
          ...
          <Section lang="de" title="Speicherdauer">
            <p>
              ...
              Ein bereits veröffentlichter Beitrag bleibt auf der jeweiligen Plattform bestehen und
              ist dort von Ihnen zu entfernen.
            </p>
          </Section>
          ...
          <Section lang="de" title="Löschung">
            ...
            <p>
              Ausführliche Anleitung: <a href={DATA_DELETION_URL}>app.immvela.com/data-deletion</a>.
            </p>
          </Section>
          ...
          <Section lang="de" title="Daten Ihrer eigenen Kundinnen und Kunden">
            <p>
              ...
              verarbeiten wir in Ihrem Auftrag. Für diese Daten bleiben Sie verantwortlich; Anfragen
              dazu richten Sie bitte an uns über die oben genannte Adresse.
            </p>
          </Section>
        </div>
        ...
        <div lang="en">
          <Section lang="en" title="Controller">
            ...
            <p>
              Immvela is SNS Software Solutions GmbH&apos;s software platform for real-estate agents
              and is not a separate legal entity. This policy describes the data we process in
              Immvela. Full company details are in the <a href="/legal/imprint">imprint</a>.
            </p>
          </Section>
          ...
          <Section lang="en" title="Connected social accounts and publishing">
            <p>
              ...
              Immvela, we store the access token issued by that platform, a refresh token where one
              is issued, the platform&apos;s account identifier, and the account&apos;s display
              name. Tokens are encrypted before they are stored.
            </p>
            <p>
          ...
          <Section lang="en" title="Content you create">
            <p>
              ...
              posts. Media files are held in non-public storage and are reached through short-lived
              signed links.
            </p>
          </Section>
          ...
          <Section lang="en" title="Records">
            <p>
              ...
              together with the aggregate engagement figures retrieved for it. These records contain
              no credentials.
            </p>
            <p>
          ...
          <Section lang="en" title="Processors">
            <p>
              Supabase (database and file storage), Vercel (hosting), Trigger.dev (background jobs)
              and Anthropic (text generation).
            </p>
            <p>
          ...
          <Section lang="en" title="Deletion">
            ...
            <p>
              To delete your entire account, email <a href={`mailto:${CONTACT}`}>{CONTACT}</a> from
              your account&apos;s email address. We carry this out{' '}
          ...
          <Section lang="en" title="Your own customers' data">
            <p>
              ...
              your behalf. You remain responsible for that data; please direct requests about it to
