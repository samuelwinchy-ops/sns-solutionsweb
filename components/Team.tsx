...
export default function Team({ locale = defaultLocale }: { locale?: Locale }) {
    ...
    >
      <div className="mx-auto w-full max-w-6xl 2xl:max-w-7xl">
        <div className="mb-14 max-w-2xl">
          ...
          <p className="mt-4 font-mono text-sm text-sns-muted">{t.note}</p>
        </div>
        ...
        <div className="grid w-full grid-cols-1 gap-5 md:grid-cols-3">
          {founders.map((founder, i) => (
            <motion.div
              ...
              className="group relative min-w-0 overflow-hidden rounded-sns-lg border border-sns-text/[0.08] bg-white/50 p-7 transition-all duration-500 ease-sns-out hover:border-sns-indigo/40 hover:bg-white/70 hover:glow-blue"
            >
              <div
                aria-hidden="true"
              ...
              <p className="mt-5 text-lg font-semibold text-sns-text">{founder.name}</p>
